...
class AvailabilityAndPriceDataRepository : AvailabilityAndPriceRepository {
    override fun getSkuToMesureAvailabilityAndPrice(): Single<Resource<List<SkuAvailabilityAndPriceData>>> {
        ...
        val sku2 = SkuAvailabilityAndPriceData("3", 1, "cerveza", "tequila", 3, true, 0.0f, false)
        val sku3 = SkuAvailabilityAndPriceData("4", 1, "RON", "tequila", 4, true, 0.0f, false)
        val sku4 = SkuAvailabilityAndPriceData("5", 1, "indio", "tequila", 5, true, 0.0f, false)
        val sku5 = SkuAvailabilityAndPriceData("6", 1, "corona", "tequila", 6, true, 0.0f, false)
        val sku6 = SkuAvailabilityAndPriceData("7", 1, "modelo", "tequila", 7, true, 0.0f, false)
        val sku7 = SkuAvailabilityAndPriceData("8", 1, "vodka", "tequila", 8, true, 0.0f, false)
        val sku8 = SkuAvailabilityAndPriceData("9", 1, "carta blanca", "tequila", 9, true, 0.0f, false)
        val sku9 = SkuAvailabilityAndPriceData("10", 1, "alcohol", "tequila", 10, true, 0.0f, false)
        val sku10 = SkuAvailabilityAndPriceData("11", 1, "XX", "tequila", 11, true, 0.0f, false)
